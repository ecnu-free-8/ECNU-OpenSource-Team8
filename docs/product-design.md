...
采用前后端分离的架构模式，前端负责用户界面和交互，后端提供API服务和数据处理。

### 5.2 技术栈详情

#### 前端技术栈

* **React 19.1.0**: 现代化的前端框架，提供组件化开发体验
* **Tailwind CSS**: 实用优先的CSS框架，快速构建响应式界面
* **Recharts**: 基于React的图表库，用于数据可视化
* **React Query (@tanstack/react-query)**: 强大的数据获取和状态管理库
...
* **SQLite**: 轻量级的关系型数据库
* **OpenAI API**: 集成大语言模型，提供自然语言处理能力

#### 开发工具

* **React Scripts**: React应用的构建和开发工具
* **PostCSS**: CSS后处理器
* **ESLint**: JavaScript代码检查工具

### 5.3 部署架构

* 前端: 构建为静态文件，可部署到任何静态文件服务器
* 后端: Flask应用，可部署到支持Python的服务器
* 数据库: SQLite文件，与后端应用一起部署
